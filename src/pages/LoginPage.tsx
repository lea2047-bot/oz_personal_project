...
import { useNavigate } from "react-router-dom"; // 1. 이동을 위한 hook 임포트
  ...
  return (
    <Layout>
      ...
      <div className="w-full flex flex-col gap-5">
        ...
        <Button className="h-14 text-lg mt-2 bg-black hover:bg-gray-800">
        ...
        <div className="text-center mt-4">
          <button 
            type="button"
            onClick={() => navigate("/signup")} // 3. 클릭 시 회원가입 페이지로 이동
